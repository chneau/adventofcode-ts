...
1. Run `bun run index aoc_2025_XX` (replace XX with the day number, zero-padded).
...
3. Read the problem description for part 1 from https://adventofcode.com/2025/day/XX with a curl command
...
## for p2:
7. Read the problem description for part 2 from https://adventofcode.com/2025/day/XX with a curl command
